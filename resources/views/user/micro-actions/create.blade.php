...
@section('title', 'Create Micro Action')
...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
    ...
    <div class="mb-6 sm:mb-8">
        ...
        <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Create New Action</h1>
        <p class="text-sm sm:text-base text-gray-600 mt-1">Add a new micro action to your list</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        <div class="bg-gradient-to-r from-blue-500 to-blue-600 px-5 sm:px-6 py-4">
            ...
            <p class="text-blue-100 text-xs sm:text-sm mt-1">Fill in the information below</p>
        </div>
        ...
        <div class="p-5 sm:p-6">
            ...
            <form method="POST" action="{{ route('micro-actions.store') }}" class="space-y-5 sm:space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input 
                            ...
                            name="action_date" 
                            id="action_date" 
                            value="{{ old('action_date', today()->format('Y-m-d')) }}"
                            required
                            class="w-full pl-9 sm:pl-10 pr-4 py-2.5 sm:py-3 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-sm sm:text-base"
                        >
                    </div>
